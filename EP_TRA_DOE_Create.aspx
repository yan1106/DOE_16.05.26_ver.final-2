...
<body>
    <form id="form1" runat="server">
        ...
        <div class="left">
            <fieldset class="auto-style1" style="margin:auto;">
                <legend class="legend" style="font-size:medium;"><strong>EP_TRA_Doe_Create</strong></legend>  
    ...
    <asp:Panel ID="Panel_EPTRA" runat="server">
           ...
           <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;width:1500px;">
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td> <asp:Panel ID="Panel_traLv_1" runat="server"></asp:Panel>　</td>
                     <td>　</td>
                     <td>　</td>
                     <td>　</td>
                 </tr>
                 <tr class="style-td-gray">
                     ...
                     <td>　
                         ...
                         <asp:Panel ID="Panel_traLv_2" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_3" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="12">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_4" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="38">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_5" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_6" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_7" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_8" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_9" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="38">
                     ...
                     <td>
                         <asp:Panel ID="Panel_traLv_10" runat="server">
                         </asp:Panel>
                         　</td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_11" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>　<asp:Panel ID="Panel_traLv_12" runat="server">
                         </asp:Panel>
                     </td>
                     <td>　</td>
                     <td>　</td>
