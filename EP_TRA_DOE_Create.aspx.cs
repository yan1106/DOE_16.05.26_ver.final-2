   ...
   /* protected void put_eptramain_data()
    ...
    protected void keyitem_put_data2(Panel temp_Lv, Panel temp_stage, Panel temp_pot, Label lab_stage, Label lab_pot, string keyitem)
    {
        ...
        if (jude_keyitem(keyitem) == true)
        {
            for (int i = 0; i < a; i++)
            {
                ...
                TraLv.ID = "Image_stage_" + temp_effect_name + i;
                ...
                TraLv.PostBackUrl = "EP_TRA_Level.aspx";
    ...
    protected void gap_compare()
    {
        ...
        if (lab_gap12.Text == "Y")
        {
            ...
            keyitem_put_data2(Panel_traLv_12,Panel_Eff_12, Panel_Pot_12, lab_Eff_12, lab_Pot_12, Lab_keyitem_12.Text);
        }
        else
        {
            lab_gap12.Text = "N";
