    ...
    <legend class="legend" style="font-weight: 700; font-size: large;">Category Information</legend> 
      <table border="1" > 
          <tr>              
              ...
              <td><asp:TextBox ID="Text_iit" runat="server"></asp:TextBox></td>                                   
          </tr> 
          ...
          <tr>
              ...
              <td><asp:TextBox ID="Text_sp" runat="server"></asp:TextBox></td>
              
               <td>
                  Methodology:
              </td>
              <td><asp:TextBox ID="Text_md" runat="server"></asp:TextBox></td>


               <td>
                  Key parameter:
              </td>
              <td><asp:TextBox ID="Text_kp" runat="server"></asp:TextBox></td>

              <td>
                 <asp:Button ID="butSearch" runat="server" Text="Search" class="blueButton button2" onclick="butSearch_Click"/>
              </td>
